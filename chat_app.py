...
def _render_app():
    ...
    css_chunks = [
        ...
        ".exaa2ht0 div[data-baseweb='textarea']{min-height:150px !important;}",
        ...
        "textarea[data-testid='stChatInputTextArea'] {max-height:150px!important; overflow-y:auto;padding-left:0 !important;padding-right:0 !important;}",

        "textarea[data-testid='stChatInputTextArea']:focus {min-height:150px !important;}",
