...
def _render_app():
    ...
    css_chunks = [
        ...
        "div[data-testid='stChatInput'] > div:first-child {position:relative;border:1px solid rgba(255,255,255,0.18);padding:0.75rem 4.5rem 0.75rem 3.25rem;transition:border-color 0.2s ease, box-shadow 0.2s ease;}",
