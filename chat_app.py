...
def _render_app():
    ...
    css_chunks = [
        ...
        "textarea[data-testid='stChatInputTextArea'] {max-height:120px!important; overflow-y:auto;padding-left:0 !important;padding-right:0 !important; padding-top: 25px}",
