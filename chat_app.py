...
def _render_app():
    ...
    css_chunks = [
        ...
        "textarea[data-testid='stChatInputTextArea'] {min-height:80px !important;max-height:250px!important; overflow-y:auto;padding-left:0 !important;padding-right:0 !important;}",
